...
export async function create(req, res) {
  const { reservation_id, card_last4 } = req.body;
  ...
  try {
    ...
    const payment = await pool.query(
      ...
      [reservation_id, r.property_title, r.guest_email, r.host_email,
       r.total_price, r.platform_fee, r.host_net, card_last4 ?? null]
    );
