    ...
    const properties = [
      {
        ...
        bathrooms: 1,
        host_name: 'Marina',
        host_email: 'admin@pocoshost.test',
      ...
      },
      {
        ...
        state: 'MG',
        category: 'chale',
        tags: ['wifi', 'rural', 'churrasco', 'pet_friendly'],
        price_per_night: 450,
        rating: 4.8,
        review_count: 21,
        max_guests: 2,
      ...
      },
      {
        ...
        state: 'MG',
        category: 'casa',
        tags: ['piscina', 'churrasco', 'familia'],
        price_per_night: 590,
        rating: 4.9,
        review_count: 42,
        max_guests: 8,
