    ...
    <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e5b251; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
      ...
      <div style="padding: 32px; background-color: #ffffff; color: #333333;">
        ...
        <div style="margin-top: 32px; text-align: center;">
          <a href="https://www.pocoshost.com/reservas" style="background-color: #111111; color: #e5b251; text-decoration: none; padding: 12px 24px; border-radius: 4px; font-weight: bold; font-size: 14px; border: 1px solid #e5b251; display: inline-block; transition: all 0.2s ease;">
            Ver Minhas Reservas
          </a>
        </div>
      </div>
...
Verifique suas reservas em: https://www.pocoshost.com/reservas
  ...
  const html = `
    <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e5b251; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
      ...
      <div style="padding: 32px; background-color: #ffffff; color: #333333;">
        ...
        <div style="margin-top: 32px; text-align: center;">
          <a href="https://www.pocoshost.com/painel/reservas" style="background-color: #111111; color: #e5b251; text-decoration: none; padding: 12px 24px; border-radius: 4px; font-weight: bold; font-size: 14px; border: 1px solid #e5b251; display: inline-block; transition: all 0.2s ease;">
...
Gerencie suas reservas em: https://www.pocoshost.com/painel/reservas
...
export async function sendPasswordReset(user, token) {
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #222;">
      <h1 style="color: #111;">PoçosHost</h1>
      <p>Olá, ${user.full_name}.</p>
      <p>Recebemos uma solicitação para redefinir a senha da sua conta. O link abaixo é válido por 1 hora.</p>
      <p style="margin: 28px 0;">
        <a href="${resetUrl}" style="background: #111; color: #fff; padding: 12px 18px; text-decoration: none; border-radius: 6px; display: inline-block;">
          Redefinir senha
        </a>
      </p>
      <p>Se o botão não funcionar, copie e cole este link no navegador:</p>
